            ...
            var order_total_fare = 0;
                ...
                if(basic_fare > 0){
                    if (symbolAtRight) {
                        ...
                        order_amount_html += '<tr ><td class="label">{{trans("lang.basic")}} '+orderData.distanceType+' {{ trans("lang.charges") }} ('+orderData.service.basicFare+' ' + orderData.distanceType+')</td><td>' + parseFloat(basic_fare).toFixed(decimal_degits) +  currentCurrency + '</td></tr>';
                    } else {

                        order_amount_html += '<tr><td class="label">{{trans("lang.basic")}} '+orderData.distanceType+' {{ trans("lang.charges") }} ('+orderData.service.basicFare+' ' + orderData.distanceType+')</td><td>' + currentCurrency  +  parseFloat(basic_fare).toFixed(decimal_degits) + '</td></tr>';
                    }
                }
