    ...
    'Purple'
                            ...
                            <div class="show_ac_non_ac_div d-none">
                                ...
                                <div class="form-group row width-50">
                                    ...
                                    <label class="col-3 control-label ">{{trans('lang.ac_charges')}}<span

                                    class="required-field"></span></label>

                                    <div class="col-7">

                                        <input type="number" class="form-control ac_charges" min="0">

                                        <div class="form-text text-muted">



                                        {{ trans('lang.driver_ac_help') }}
                                ...
                                <div class="form-group row width-50">
                                    ...
                                    <label class="col-3 control-label">{{trans('lang.nonac_charges')}}<span

                                    class="required-field"></span></label>

                                    <div class="col-7">

                                        <input type="number" class="form-control nonac_charges" min="0">

                                        <div class="form-text text-muted">



                                        {{ trans('lang.driver_nonac_help') }}
...
<script>
    ...
    $('#user_service').on('change',function(){
        ...
        if(data_is_acnonac && data_is_acnonac == "true"){
            ...
            $(".show_km_charges_div").addClass('d-none');
    ...
    $(document).ready(async function() {
        ...
        await database.collection('service').where('enable','==',true).get().then(async function(snapshots) {
            ...
            snapshots.docs.forEach((listval) => {
                ...
                $('#user_service').append($("<option></option>")
                    ...
                    .attr("data-is-acnonac",data.isAcNonAc)

                    .attr("data-ac-charge",(data.acCharge ? data.acCharge : ''))

                    .attr("data-non-ac-charge",(data.nonAcCharge ? data.nonAcCharge : ''))

                    .attr('data-km-charge',data.kmCharge)
        ...
        database.collection('vehicle_type').where('enable','==',true).get().then(async function(snapshots) {
            ...
            snapshots.docs.forEach((listval) => {
                ...
                $('#vehicle_type').append($("<option></option>")
                    ...
                    .attr("data-name",JSON.stringify(data.name))
        ...
        $(".edit-form-btn").click(async function() {
            ...
            var vehicleTypeName=JSON.parse($("#vehicle_type :selected").attr('data-name'));
            ...
            }else if(data_is_acnonac && data_is_acnonac == "true" && (ac_charges==''||ac_charges<=0)) {

                $(".error_top").show();

                $(".error_top").html("");

                $(".error_top").append("<p>{{ trans('lang.please_enter_valid') }}  {{ trans('lang.ac_charges') }}</p>");

                window.scrollTo(0,0);



            } else if(data_is_acnonac && data_is_acnonac == "true" && service_ac_charges != null && service_ac_charges != "" && parseFloat(ac_charges) > parseFloat(service_ac_charges)){

                $(".error_top").show();

                $(".error_top").html("");

                $(".error_top").append("<p>{{ trans('lang.please_enter_valid_ac_charges') }} "+service_ac_charges+"</p>");

                window.scrollTo(0,0);

            }else if(data_is_acnonac && data_is_acnonac == "true" && (nonac_charges==''||nonac_charges<=0)) {

                $(".error_top").show();

                $(".error_top").html("");

                $(".error_top").append("<p>{{ trans('lang.please_enter_valid') }} {{ trans('lang.nonac_charges') }}</p>");

                window.scrollTo(0,0);



            }else if(data_is_acnonac && data_is_acnonac == "true" && service_nonac_charges != null && service_nonac_charges != "" && parseFloat(nonac_charges) > parseFloat(service_nonac_charges)){

                $(".error_top").show();

                $(".error_top").html("");

                $(".error_top").append("<p>{{ trans('lang.please_enter_valid_nonac_charges') }}"+service_nonac_charges+"</p>");
                ...
                storeImageData().then(IMG => {
                    ...
                    if(subscriptionPlanId!='' && subscriptionPlanId!=null){
                        ...
                        updateData={
                            ...
                            'vehicleInformation.acPerKmRate': ac_charges,                        

                            'vehicleInformation.nonAcPerKmRate': nonac_charges,

                            'vehicleInformation.perKmRate': km_charges,
