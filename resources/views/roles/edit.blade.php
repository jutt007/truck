...
<div class="page-wrapper">
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  value="map"
                                                                                                  name="god-eye[]"
                                                                                                  class="permission" {{in_array('map', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  value="roles.list"
                                                                                                  name="roles[]"
                                                                                                  class="permission" {{in_array('roles.list', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  value="roles.create"
                                                                                                  name="roles[]"
                                                                                                  class="permission" {{in_array('roles.create', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  value="roles.store"
                                                                                                  name="roles[]"
                                                                                                  class="permission" {{in_array('roles.store', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  value="roles.edit"
                                                                                                  name="roles[]"
                                                                                                  class="permission" {{in_array('roles.edit', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  value="roles.update"
                                                                                                  name="roles[]"
                                                                                                  class="permission" {{in_array('roles.update', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  value="roles.delete"
                                                                                                  name="roles[]"
                                                                                                  class="permission" {{in_array('roles.delete', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  value="admin.list"
                                                                                                  name="admins[]"
                                                                                                  class="permission" {{in_array('admin.list', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  value="admin.create"
                                                                                                  name="admins[]"
                                                                                                  class="permission" {{in_array('admin.create', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  value="admin.store"
                                                                                                  name="admins[]"
                                                                                                  class="permission" {{in_array('admin.store', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  value="admin.edit"
                                                                                                  name="admins[]"
                                                                                                  class="permission" {{in_array('admin.edit', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  value="admin.update"
                                                                                                  name="admins[]"
                                                                                                  class="permission" {{in_array('admin.update', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  value="admin.delete"
                                                                                                  name="admins[]"
                                                                                                  class="permission" {{in_array('admin.delete', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  value="user.list"
                                                                                                  name="users[]"
                                                                                                  class="permission" {{in_array('user.list', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  value="user.edit"
                                                                                                  name="users[]"
                                                                                                  class="permission" {{in_array('user.edit', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  value="user.view"
                                                                                                  name="users[]"
                                                                                                  class="permission" {{in_array('user.view', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  value="user.delete"
                                                                                                  name="users[]"
                                                                                                  class="permission" {{in_array('user.delete', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  value="driver.list"
                                                                                                  name="drivers[]"
                                                                                                  class="permission" {{in_array('driver.list', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  value="driver.edit"
                                                                                                  name="drivers[]"
                                                                                                  class="permission" {{in_array('driver.edit', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  value="driver.view"
                                                                                                  name="drivers[]"
                                                                                                  class="permission" {{in_array('driver.view', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  value="driver.delete"
                                                                                                  name="drivers[]"
                                                                                                  class="permission" {{in_array('driver.delete', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  id="approve-drivers-list"
                                                                                                  value="approve.driver.list"
                                                                                                  name="approve_drivers[]"
                                                                                                  class="permission" {{in_array('approve.driver.list', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                ...
                                                <label class=" control-label2"
                                                       for="approve-drivers-view">{{trans('lang.view')}}</label>-->
                                                                                           <input type="checkbox"
                                                                                                  id="approve-drivers-delete"
                                                                                                  value="approve.driver.delete"
                                                                                                  name="approve_drivers[]"
                                                                                                  class="permission" {{in_array('approve.driver.delete', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="approve-drivers-delete">{{trans('lang.delete')}}</label>
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  id="pending-drivers-list"
                                                                                                  value="pending.driver.list"
                                                                                                  name="pending_drivers[]"
                                                                                                  class="permission" {{in_array('pending.driver.list', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class="control-label2"
                                                ...
                                                <label class="control-label2"
                                                       for="pending-drivers-view">{{trans('lang.view')}}</label>-->
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  id="pending-drivers-delete"
                                                                                                  value="pending.driver.delete"
                                                                                                  name="pending_drivers[]"
                                                                                                  class="permission" {{in_array('pending.driver.delete', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="pending-drivers-delete">{{trans('lang.delete')}}</label>
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  value="document.list"
                                                                                                  name="documents[]"
                                                                                                  class="permission" {{in_array('document.list', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="documents[]"
                                                                                                  class="permission" {{in_array('document.create', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  value="document.edit"
                                                                                                  name="documents[]"
                                                                                                  class="permission" {{in_array('document.edit', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="documents[]"
                                                                                                  class="permission" {{in_array('document.delete', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
       ...
       'disabled' : ''}}>
                                                                                           ...
                                                                                           <label class=" control-label2"
                                                                                                  for="deleted-documents-list">{{trans('lang.list')}}</label>
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  id="driver-document-list"
                                                                                                  value="driver.document.list"
                                                                                                  name="drivers-document[]"
                                                                                                  class="permission" {{in_array('driver.document.list', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  id="driver-document-edit"
                                                                                                  value="driver.document.edit"
                                                                                                  name="drivers-document[]"
                                                                                                  class="permission" {{in_array('driver.document.edit', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  value="user.report"
                                                                                                  name="reports[]"
                                                                                                  class="permission" {{in_array('user.report', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class="control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  value="driver.report"
                                                                                                  name="reports[]"
                                                                                                  class="permission" {{in_array('driver.report', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class="control-label2"
                                                                                                  for="driver-report">{{trans('lang.driver')}}</label>

                                                                                           <input type="checkbox"
                                                                                                  id="ride-report"
                                                                                                  value="ride.report"
                                                                                                  name="reports[]"
                                                                                                  class="permission" {{in_array('ride.report', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class="control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  id="intercity-report"
                                                                                                  value="intercity.report"
                                                                                                  name="reports[]"
                                                                                                  class="permission" {{in_array('intercity.report', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class="control-label2"
                                                                                                  for="intercity-report">{{trans('lang.intercity')}}</label>

                                                                                           <input type="checkbox"
                                                                                                  id="transaction-report"
                                                                                                  value="transaction.report"
                                                                                                  name="reports[]"
                                                                                                  class="permission" {{in_array('transaction.report', $permissions) ? "checked" : "" }} {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class="control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  class="permission" {{in_array('subscription-plans', $permissions) ? "checked" : "" }} {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="subscription-plans[]"
                                                                                                  class="permission" {{in_array('subscription-plans.create', $permissions) ? "checked" : "" }} {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="subscription-plans-create">{{ trans('lang.create') }}</label>
                                                                                           <input type="checkbox"
                                                                                                  id="subscription-plans-edit"
                                                                                                  value="subscription-plans.edit"
                                                                                                  name="subscription-plans[]"
                                                                                                  class="permission" {{in_array('subscription-plans.edit', $permissions) ? "checked" : "" }} {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="subscription-plans[]"
                                                                                                  class="permission" {{in_array('subscription-plans.delete', $permissions) ? "checked" : "" }} {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  class="permission" {{in_array('subscription.history', $permissions) ? "checked" : "" }} {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  value="service.list"
                                                                                                  name="service[]"
                                                                                                  class="permission" {{in_array('service.list', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="service[]"
                                                                                                  class="permission" {{in_array('service.create', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="service-create">{{trans('lang.create')}}</label>

                                                                                           <input type="checkbox"
                                                                                                  id="service-edit"
                                                                                                  value="service.edit"
                                                                                                  name="service[]"
                                                                                                  class="permission" {{in_array('service.edit', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="service[]"
                                                                                                  class="permission" {{in_array('service.delete', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="service-delete">{{trans('lang.delete')}}</label>
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  value="order.list"
                                                                                                  name="ride_order[]"
                                                                                                  class="permission" {{in_array('order.list', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  value="order.view"
                                                                                                  name="ride_order[]"
                                                                                                  class="permission" {{in_array('order.view', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  id="ride-order-delete"
                                                                                                  value="order.delete"
                                                                                                  name="ride_order[]"
                                                                                                  class="permission" {{in_array('order.delete', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
       ...
       'disabled' : ''}}>
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  id="intercity-order-list"
                                                                                                  value="intercity.order.list"
                                                                                                  name="intercity_order[]"
                                                                                                  class="permission" {{in_array('intercity.order.list', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="intercity-order-list">{{trans('lang.list')}}</label>

                                                                                           <input type="checkbox"
                                                                                                  id="intercity-order-view"
                                                                                                  value="intercity.order.view"
                                                                                                  name="intercity_order[]"
                                                                                                  class="permission" {{in_array('intercity.order.view', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="intercity-order-view">{{trans('lang.view')}}</label>

                                                                                           <input type="checkbox"
                                                                                                  id="intercity-order-delete"
                                                                                                  value="intercity.order.delete"
                                                                                                  name="intercity_order[]"
                                                                                                  class="permission" {{in_array('intercity.order.delete', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="intercity-order-delete">{{trans('lang.delete')}}</label>
       ...
       'disabled' : ''}}>
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  id="freight-create"
                                                                                                  value="freight.create"
                                                                                                  name="freight[]"
                                                                                                  class="permission" {{in_array('freight.create', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="freight-create">{{trans('lang.create')}}</label>
       ...
       'disabled' : ''}}>
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="freight[]"
                                                                                                  class="permission" {{in_array('freight.delete', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="freight-delete">{{trans('lang.delete')}}</label>
       ...
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="airports-list">{{trans('lang.list')}}</label>

                                                                                           <input type="checkbox"
                                                                                                  id="airports-create"
                                                                                                  value="airports.create"
                                                                                                  name="airports[]"
                                                                                                  class="permission" {{in_array('airports.create', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="airports-create">{{trans('lang.create')}}</label>
       ...
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="airports-edit">{{trans('lang.edit')}}</label>

                                                                                           <input type="checkbox"
                                                                                                  id="airports-delete"
                                                                                                  value="airports.delete"
                                                                                                  name="airports[]"
                                                                                                  class="permission" {{in_array('airports.delete', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="airports-delete">{{trans('lang.delete')}}</label>
       ...
       'disabled' : ''}}>
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  id="vehicle-type-create"
                                                                                                  value="vehicle.type.create"
                                                                                                  name="vehicle-type[]"
       ...
       'disabled' : ''}}>
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  id="vehicle-type-delete"
                                                                                                  value="vehicle.type.delete"
                                                                                                  name="vehicle-type[]"
                                                                                                  class="permission" {{in_array('vehicle.type.delete', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
       ...
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="driver-rules-list">{{trans('lang.list')}}</label>

                                                                                           <input type="checkbox"
                                                                                                  id="driver-rules-create"
                                                                                                  value="rule.create"
                                                                                                  name="driver-rules[]"
       ...
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="driver-rules-create">{{trans('lang.create')}}</label>

                                                                                           <input type="checkbox"
                                                                                                  id="driver-rules-edit"
                                                                                                  value="rule.edit"
                                                                                                  name="driver-rules[]"
       ...
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="driver-rules-edit">{{trans('lang.edit')}}</label>

                                                                                           <input type="checkbox"
                                                                                                  id="driver-rules-delete"
                                                                                                  value="rule.delete"
                                                                                                  name="driver-rules[]"
                                                                                                  class="permission" {{in_array('rule.delete', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="driver-rules-delete">{{trans('lang.delete')}}</label>
                                                                                    </td>
                                                                             </tr>
                                                                             <tr>
                                                                                    <td>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  id="deleted-driver-rules-list"
                                                                                                  value="rule.delete.list"
                                                                                                  name="deleted-driver-rules[]"
                                                                                                  class="permission" {{in_array('rule.delete.list', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="deleted-driver-rules-list">{{trans('lang.list')}}</label>
       ...
       'disabled' : ''}}>
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  value="cms.delete"
                                                                                                  name="cms[]"
                                                                                                  class="permission" {{in_array('cms.delete', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class="control-label2"
       ...
       'disabled' : ''}}>
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="banners[]"
                                                                                                  class="permission" {{in_array('banners.delete', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  id="deleted-banner"
                                                                                                  value="banner.delete.list"
                                                                                                  name="deleted-banner[]"
                                                                                                  class="permission" {{in_array('banner.delete.list', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class="control-label2"
                                                                                                  for="deleted-banner">{{trans('lang.list')}}</label>
       ...
       'disabled' : ''}}>
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  value="faq.delete"
                                                                                                  name="faq[]"
                                                                                                  class="permission" {{in_array('faq.delete', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
       ...
       'disabled' : ''}}>
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  value="sos.delete"
                                                                                                  name="sos[]"
                                                                                                  class="permission" {{in_array('sos.delete', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
       ...
       'disabled' : ''}}>
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  value="tax.delete"
                                                                                                  name="tax[]"
                                                                                                  class="permission" {{in_array('tax.delete', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
       ...
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="coupon-create">{{trans('lang.create')}}</label>
                                                                                           <input type="checkbox"
                                                                                                  id="coupon-edit"
                                                                                                  value="coupon.edit"
                                                                                                  name="coupon[]"
       ...
       'disabled' : ''}}>
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  value="coupon.delete"
                                                                                                  name="coupon[]"
                                                                                                  class="permission" {{in_array('coupon.delete', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="coupon-delete">{{trans('lang.delete')}}</label>
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  id="deleted-coupon-list"
                                                                                                  value="coupon.delete.list"
                                                                                                  name="deleted-coupon[]"
                                                                                                  class="permission" {{in_array('coupon.delete.list', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="deleted-coupon-list">{{trans('lang.list')}}</label>
       ...
       'disabled' : ''}}>
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="currency[]"
                                                                                                  class="permission" {{in_array('currency.delete', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
       ...
       'disabled' : ''}}>
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="language[]"
                                                                                                  class="permission" {{in_array('language.delete', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
       ...
       'disabled' : ''}}>
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  id="drivers-wallet-transactions"
       ...
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="drivers-wallet-transactions">{{trans('lang.list')}}</label>
       ...
       'disabled' : ''}}>
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  id="admin-commission"
                                                                                                  value="admin-commision"
                                                                                                  name="admin-commission[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('admin-commision', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  {{in_array('schedule-notification', $permissions) ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ? 'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="schedule-notification">{{trans('lang.update')}}</label>
       ...
       'disabled' : ''}}>
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  value="zone.delete"
                                                                                                  name="zone[]"
                                                                                                  class="permission" {{in_array('zone.delete', $permissions)
       ? "checked" : "" }} {{$roles->id == 1 ?
       'disabled' : ''}}>
                                                                                           <label class=" control-label2"
