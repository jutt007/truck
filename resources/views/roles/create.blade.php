                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="checkbox" id="documents-create"
                                                            ...
                                                            class="permission">
                                                        <label class=" control-label2"
                                                            for="documents-create">{{trans('lang.view')}}</label>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="checkbox" id="intercity-report"
                                                            value="intercity.report" name="reports[]"
                                                            class="permission">
                                                        <label class="control-label2"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="checkbox" id="service-create"
                                                            value="service.create" name="service[]" class="permission">
                                                        <label class=" control-label2"
                                                        ...
                                                        <input type="checkbox" id="service-delete"
                                                            value="service.delete" name="service[]" class="permission">
                                                        <label class=" control-label2"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="checkbox" id="intercity-order-delete"
                                                            value="intercity.order.delete" name="intercity_order[]"
                                                            class="permission">
                                                        <label class=" control-label2"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="checkbox" id="freight-create"
                                                            value="freight.create" name="freight[]" class="permission">
                                                        <label class=" control-label2"
                                                        ...
                                                        <input type="checkbox" id="freight-delete"
                                                            value="freight.delete" name="freight[]" class="permission">
                                                        <label class=" control-label2"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="checkbox" id="airports-create"
                                                            value="airports.create" name="airports[]"
                                                            class="permission">
                                                        <label class=" control-label2"
                                                        ...
                                                        <input type="checkbox" id="airports-delete"
                                                            value="airports.delete" name="airports[]"
                                                            class="permission">
                                                        <label class=" control-label2"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="checkbox" id="driver-rules-create"
                                                            value="rule.create" name="driver-rules[]"
                                                            class="permission">
                                                        <label class=" control-label2"
                                                        ...
                                                        <input type="checkbox" id="driver-rules-delete"
                                                            value="rule.delete" name="driver-rules[]"
                                                            class="permission">
                                                        <label class=" control-label2"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="checkbox" id="banners-create"
                                                            value="banners.create" name="banners[]" class="permission">
                                                        <label class=" control-label2"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="sos-list" value="sos.list"
                                                            name="sos[]" class="permission">
                                                        <label class=" control-label2"
                                                            for="sos-list">{{trans('lang.list')}}</label>

                                                        <input type="checkbox" id="sos-edit" value="sos.edit"
                                                            name="sos[]" class="permission">
                                                        <label class=" control-label2"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="drivers-wallet-transactions"
                                                            ...
                                                            name="drivers-wallet-transaction[]" class="permission">
                                                        <label class=" control-label2"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="schedule-notification"
                                                            value="schedule-notification" name="schedule-notification[]"
                                                            class="permission">
                                                        <label class=" control-label2"
